...
import { playerId, playerName, setLocalOwned } from '../../lib/identity';
 ...
 *
 * The arcade shell owns identity and the shelf; everything below the shelf is
...
export function PenFightGame({ onExit, onRename }: { onExit: () => void; onRename: () => void }) {
  // ---------------------------------------------------------------- identity
